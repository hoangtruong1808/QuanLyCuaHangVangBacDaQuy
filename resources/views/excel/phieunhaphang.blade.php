<table>
    <thead>
        ...
        <tr>
            <th colspan='6'>Nhà cung cấp: {{$phieunhaphang->nhacungcap}}</th>
        </tr>
        <tr>

        </tr>
        <tr>
            <th colspan='6'>Số điện thoại: {{$phieunhaphang->sodienthoai}}</th>
        </tr>
        <tr>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ number_format($phieunhaphang->TongGiaTri) }} VNĐ</td>
        </tr>
        <tr>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan='3'></td>
            <td colspan='3' style="text-align: center"><b><i>{{$phieunhaphang->nhanvien}}</i></b></td>
        </tr>
    </tbody>
</table>        