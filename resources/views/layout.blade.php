...
<!-- bootstrap-css -->
<link rel="stylesheet" href="{{asset('public/backend/css/fontawesome-free-6.0.0-beta2-web/css/all.min.css')}}" />
...
<script src="{{asset('public/backend/select2/select2.min.js')}}"></script>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{URL::to('/chat-view')}}"><i class="fa fa-key"></i> Chat</a></li>
