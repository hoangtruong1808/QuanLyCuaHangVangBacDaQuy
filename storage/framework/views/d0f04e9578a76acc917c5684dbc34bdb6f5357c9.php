...
<!-- bootstrap-css -->
<link rel="stylesheet" href="<?php echo e(asset('public/backend/css/fontawesome-free-6.0.0-beta2-web/css/all.min.css')); ?>" />
...
<!-- select 2 -->
<link rel="stylesheet" href="<?php echo e(asset('public/backend/select2/select2.min.css')); ?>">
<script src="<?php echo e(asset('public/backend/select2/select2.min.js')); ?>"></script>
...
<div class="nav notify-row" id="top_menu">
	<?php echo $__env->yieldContent('admin_header'); ?>
</div>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="<?php echo e(URL::to('/chat-view')); ?>"><i class="fa fa-key"></i> Chat</a></li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li class="sub-menu">
                    <a href="<?php echo e(URL::to('danh-sach-khach-hang')); ?>">
                ...
                <li class="sub-menu">
                    <a href="<?php echo e(URL::to('danh-sach-nha-cung-cap')); ?>">
                        <i class="fa fa-book"></i>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo e(URL::to('danh-sach-nhan-vien')); ?>">Danh sách nhân viên</a></li>
                        <li><a href="<?php echo e(URL::to('diem-danh-nhan-vien')); ?>">Điểm danh nhân viên</a></li>
                    </ul>
                </li>

                <li class="sub-menu">
                    <a href="<?php echo e(URL::to('danh-sach-danh-muc')); ?>">
                        <i class="fa fa-book"></i>
                ...
                <li class="sub-menu">
                    <a href="<?php echo e(URL::to('danh-sach-san-pham')); ?>">
                        <i class="fa fa-book"></i>
                        <span>Sản phẩm</span>
                    </a>
                </li>
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo e(URL::to('lap-phieu-nhap-hang')); ?>">Lập phiếu nhập hàng</a></li>
                        <li><a href="<?php echo e(URL::to('lap-phieu-mua-hang')); ?>">Lập phiếu mua hàng</a></li>
                        <li><a href="<?php echo e(URL::to('lap-phieu-ban-hang')); ?>">Lập phiếu bán hàng</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="<?php echo e(URL::to('bao-cao-ton-quy')); ?>">
                        <i class="fa fa-book"></i>
...
<?php /**PATH C:\xampp\htdocs\QuanLyCuaHangVangBacDaQuy\resources\views/layout.blade.php ENDPATH**/ ?>